/*
  # Improved session isolation and activity tracking

  1. Security
    - Enhanced RLS policies for user_activity_logs
    - Added session isolation for user accounts
    - Improved JWT claim handling
  
  2. Performance
    - Added optimized indexes for session queries
    - Created functions for efficient activity logging
  
  3. Maintenance
    - Added session cleanup functionality
    - Implemented automatic session duration calculation
*/
