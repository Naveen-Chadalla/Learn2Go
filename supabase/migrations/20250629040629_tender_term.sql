/*
  ...
  1. Changes
    - Replace jwt() function with current_setting('request.jwt.claims', true)::json
    - Keep all the same policies and functionality
    - Fix session isolation and activity tracking
  2. Security
    - Maintain all RLS policies with proper JWT claim access
    - Preserve session isolation constraints
*/
