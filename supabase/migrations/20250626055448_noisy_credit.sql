...
DROP INDEX IF EXISTS user_progress_username_lesson_id_key;
CREATE UNIQUE INDEX user_progress_username_lesson_id_key ON user_progress USING btree (username, lesson_id);